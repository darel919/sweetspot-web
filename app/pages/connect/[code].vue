...
import { useCalibrationRemoteMic } from '~/composables/calibration/useCalibrationRemoteMic'
import ConnectStateSection from '~/components/connect/ConnectStateSection.vue'
import { isCalibrationActiveStage } from '~/composables/calibration/useCalibrationSession'
